...
public class MyCrashHandler implements UncaughtExceptionHandler {
    ...
    public static MyCrashHandler getInstance() {
        return MyCrashHandlerHolder.mInstance;
    }

    public static class MyCrashHandlerHolder{
        @SuppressLint("StaticFieldLeak")
        private static final MyCrashHandler mInstance=new MyCrashHandler();
    }
    ...
    public void handleExceptionOnUi(){
        new Thread() {
            @Override
            public void run() {
                Looper.prepare();
